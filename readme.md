...
* **Key Features:** Fuzzy searching mechanics, immediate category tabs/filters, copy-on-click shortcuts, and deep descriptions for everyday terminal processes.

### 2. 📜 Scripting & Advanced Concepts (`Bash Scripting Reference.html`)
* **Focus:** Structural paradigms of shell code design including arrays, conditional tests, text stream processors (`sed`, `awk`, `grep`), function execution scopes, expansion tokens, and debugging parameters.
* **Key Features:** Embedded syntactical templates, detailed code snippets, and structured technical data schemas.
